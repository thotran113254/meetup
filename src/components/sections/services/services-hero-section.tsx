...
/**
 * ServicesHeroSection — Full-width hero with car fleet image,
 * teal gradient overlay, infinite "SERVICE" marquee, and breadcrumb.
 * Figma: node 13845:15294
 */
export function ServicesHeroSection() {
  return (
    <section className="w-full bg-[var(--color-background)] px-4 sm:px-6 lg:px-[27px] pt-4 sm:pt-[37px]">
      ...
      >
        <Image
          src="/images/service-hero-banner.jpg"
          alt="Meetup Travel Services — Premium fleet vehicles"
          fill
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to bottom, rgba(59,188,183,0) 0%, #3BBCB7 100%)",
          }}
        />

        {/* Marquee — infinite scroll "SERVICE * SERVICE *" */}
      ...
      >
        <ol className="flex items-center gap-2 text-[12px] font-medium leading-[1.2]">
          ...
          <li className="text-[#1D1D1D]">Service</li>
        </ol>
      </nav>

      <h1 className="sr-only">
        Travel Services — Fast Track, eVisa, Airport Pickup, eSim &amp; Custom Tours
      </h1>
    </section>
  );
}
