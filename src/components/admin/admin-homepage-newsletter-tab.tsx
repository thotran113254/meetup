...
/** Editor for the Newsletter section — syncs from parent once on initial load only. */
  ...
  return (
    <div className="space-y-4 max-w-lg">
      <FormField label="Tiêu đề" htmlFor="nl-title">
        <input id="nl-title" className={inputStyles} value={local.title}
          onChange={(e) => setLocal((p) => ({ ...p, title: e.target.value }))} />
      </FormField>
      <FormField label="Mô tả" htmlFor="nl-desc">
        <textarea id="nl-desc" rows={4}
